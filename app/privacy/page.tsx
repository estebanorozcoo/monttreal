    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">{t('section2Text')}</p>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            {t('section6Text')} <a href="mailto:info@monttreal.com" className="text-emerald-600 hover:underline">info@monttreal.com</a>
          </p>
        </section>
      </div>
    </div>
...
export async function generateMetadata() {
  return {
    title: 'Política de Privacidad - Monttreal',
    description: 'Política de privacidad de Monttreal',
  };
}
